...
<body>
    ...
    <form class="uniForm" id="uniValidation" method = "POST" action = "<?php echo base_url();?>admin/themes/default/validation/testpassword?id=<?php echo $id = $this->input->get('id');?>">
        <p>You need a password to access this survey</p>
        <input type="text" name="password" /><input type="submit" name="submit" value="Validate" />
    </form>
