<div class="rowelement">
    ...
    <div class="col-5">
        <input type="text" id="answer_yes" name="answer_yes" class="form-control" value="<?php echo $answers[0]; ?>" />
    </div>
    ...
    <div class="col-5">
        <input type="text" id="answer_no" name="answer_no" class="form-control" value="<?php echo $answers[1]; ?>" />
    </div>
</div>
