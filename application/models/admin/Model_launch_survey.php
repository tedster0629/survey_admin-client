...
class Model_launch_survey extends CI_Model
{

    //public $table_tamplating = "tbl_templating";
    ...
    public function getfileSize($survey_id, $ids)
    {
        $result = $this->db->query("SELECT rule FROM tbl_answers_add WHERE question_id = '$ids' and survey_id = '$survey_id'");
        return $result->result_array();
    }
}